          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown heading2">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <Link className="dropdown-item">Department 1</Link>
                <Link className="dropdown-item">Department 2</Link>
                <Link className="dropdown-item">Department 3</Link>
              </div>
            </li>
            <li class="nav-item dropdown heading2">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <Link className="dropdown-item">Category 1</Link>
                <Link className="dropdown-item">Category 2</Link>
                <Link className="dropdown-item">Category 3</Link>
              </div>
            </li>
          </ul>
